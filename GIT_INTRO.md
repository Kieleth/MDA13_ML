...
Un **repositorio** (o "repo") es simplemente una carpeta de archivos que tiene Git activado. Eso significa que Git está registrando los cambios. La carpeta del taller (`MDA13_ML`) es un repositorio.
